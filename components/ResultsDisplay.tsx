    ...
    <div className="bg-white border border-gray-200 rounded-lg p-5 transition-all duration-300 hover:border-blue-300 hover:shadow-md">
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <h3 className="text-lg font-bold text-gray-800 mt-2">{suggestion.title}</h3>
...
export const ResultsDisplay: React.FC<{ result: AnalysisResult; sources: GroundingChunk[] }> = ({ result, sources }) => (
  <div className="space-y-8">
    <h2 className="text-2xl font-bold text-slate-800 border-b pb-3 mb-6">Sugestões de Melhoria</h2>
    <div>
    ...
    {sources && sources.length > 0 && (
      <div>
        <h3 className="text-xl font-semibold text-gray-700 mb-3">Fontes de Dados</h3>
             ...
             source.maps && (
              <li key={index}>
                <a 
                  ...
                  className="flex items-center gap-2 text-blue-600 hover:text-blue-800 bg-gray-50 p-3 rounded-lg transition-colors border border-gray-200 hover:border-blue-300"
                >
